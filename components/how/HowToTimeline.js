    ...
    <div className="flex flex-col gap-7 items-start">
      ...
      <div className="flex flex-col gap-4 items-start">
            ...
            return (
              <div key={instruction.title} className="relative">
                ...
                {index < instructions.length - 1 && (
                  <div className="absolute left-[-20px] top-8 w-0.5 h-full bg-muted" />
                )}
                {/* Icon circle */}
                <div className="absolute left-[-28px] top-0 w-6 h-6 rounded-full bg-muted flex items-center justify-center">
        ...
        <div className="flex gap-2 items-center">
          <FaInfoCircle className="text-warning size-4" />
